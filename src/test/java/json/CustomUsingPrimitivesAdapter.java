...
public class CustomUsingPrimitivesAdapter implements JsonDeserializer<UsingPrimitive>, JsonSerializer<UsingPrimitive> {
    @Override
    public UsingPrimitive deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    @Override
    public JsonElement serialize(UsingPrimitive src, Type typeOfSrc, JsonSerializationContext context) {

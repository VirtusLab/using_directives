...
CommentsTests {
    ...
    String plainComment = "// using plainComment0123 \"pcValue\", \"pcValue1\", \"pcValue2\", \"pcValue3\"";
    ...
    public void testSpecialComments() {
        ...
        testCode(UsingDirectiveKind.SpecialComment, 1, numericScalaVersionDirective, binaryScalaVersionNumericComment);
